...
function Get-ReleaseApprovalInfo {
    ...
    $uri = "https://vsrm.dev.azure.com/<org>/<proj>/_apis/release/approvals?releaseIdsFilter=$releaseId&statusFilter=Approved&api-version=7.1-preview.3"
    ...
    if ($commentsByApprover -like '*SKIP*') {
        ...
        $uri = "https://vssps.dev.azure.com/<org>/<proj>/_apis/identities?identityIds=$identityId&queryMembership=None&api-version=7.1-preview.1"
